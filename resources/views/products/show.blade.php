        ...
        <div class="grid grid-cols-2 gap-6">
            ...
            <div>
                ...
                <div class="flex">
                    ...
                    <a class="text-orange-400 underline hover:text-orange-600" href="">18 comentarios</a>
                </div>
                <p class="text-2xl font-semibold text-trueGray-700 my-4">Bs {{ $product->price }}</p>
                <div class="bg-white rounded-lg shadow-lg mb-6">
                    <div class="p-4 flex items-center">
                        ...
                        <div class="ml-4">
                            <p class="text-lg font-semibold text-greenLime-600">Se hacen envios a toda Bolivia</p>
                            <p>Recibelo el: {{ now()->addDay(2)->isoFormat('LL') }}</p>
                        </div>
                    </div>
                </div>
            </div>
